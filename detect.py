...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("CrossingArea", 1, "CrossingArea")

        # Train or validation dataset?
        assert subset in ["train", "val"]
        dataset_dir: Union[bytes, str] = os.path.join(dataset_dir, subset)
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "CrossingArea":
...
def train(model):
    ...
    print("dataset train is loading ")
    ...
    model_path ="mask_rcnn_railcrossing.h5"
